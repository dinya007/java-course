...
public class EnumUtils {
    ...
    public static <T extends Enum<?>> void addEnum(Class<T> enumType, String enumName, Class<?>[] types, Object[] objects) {
        // 0. Sanity checks
        ...
        try {
            ...
            T newValue = (T) makeEnum(enumType, // The target enum class
                    ...
                    objects); // can be used to pass values to the enum constuctor
